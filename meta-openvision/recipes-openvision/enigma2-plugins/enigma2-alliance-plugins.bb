...
SRC_URI = "git://github.com/OpenVisionE2/alliance-plugins.git;protocol=http;branch=python3"
...
DEPENDS = "\
    ...
    minidlna \
    neon \
    python3-beautifulsoup4 python3-dnspython python3-icalendar python3-lxml python3-pexpect python3-py3amf python3-pyusb python3-simplejson \
    satipclient \
...
RDEPENDS_enigma2-plugin-extensions-lcd4linux = "bitratecalc lcd4linux python3-icalendar python3-pyusb python3-codecs python3-datetime python3-pillow python3-twisted-web python3-shell python3-ctypes libusb1 python-mutagen python3-email python3-simplejson python-soco"
FILES_enigma2-plugin-extensions-lcd4linux_append = " ${libdir}/enigma2/python/Components/Renderer/*.py ${libdir}/enigma2/python/Plugins/Extensions/LCD4linux/plugin.py"
...
RDEPENDS_enigma2-plugin-extensions-ondemand = "python3-beautifulsoup python3-dnspython python3-lxml python3-py3amf python3-simplejson"
